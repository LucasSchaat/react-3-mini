...
class App extends Component {
  ...
  filterByMake() {
    ...
    .catch( err => toast.error('Can not filter!'))
  }
  ...
  addCar() {
    ...
    .catch( err => toast.error('Could not create vehicle!'))
  }
  ...
  deleteBuyer(id) {
    ...
    .catch( err => toast.error('Can not delete!'))
  }
  ...
  byYear() {
    ...
    .catch( err => toast.error('Year filter error!'))
  }
